...
* // Declarations here ...
	...
	jsr 	(Music_sndh+8)             ; Play SNDH music
...
Restore_st:
	...
	jsr	Music_sndh+4                 ; Stop SNDH music
...
Decomp_Music_sndh:
	lea	MUSIC_LZ7,a0                 ; datas compressed
	lea	Music_sndh,a1                ; buffer destination
	jsr	d_lz77                       ; decompress datas in a0 -> a1
	rts

Decomp_Image:
	lea	IMAGE_LZ7,a0                 ; datas compressed
	lea	Image,a1                     ; buffer destination
	jsr	d_lz77                       ; decompress datas in a0 -> a1
	rts

***************************************************************
*                                                             *
*    Very fast lz77 decompression routine (68000 version)     *
*                                                             *
***************************************************************
 include "lz77_130.s"
 even
...
IMAGE_LZ7:
	incbin "LOGOA2.LZ7.SND"
	even

MUSIC_LZ7:
	incbin "LTC01_V1.LZ7.SND"
	even
...
Palette_Image equ Image+2          ; Pointer of palette
Image_begin equ Image+34           ; Pointer of picture
